...
export const dict: Record<I18nKey, string> = {
  ...
  "mobile.connect.token.placeholder": "Необовʼязково",
  "mobile.connect.connectButton": "Підключити",
  "mobile.connect.connecting": "Підключення...",
  "mobile.connect.scanQr": "Сканувати QR",
  "mobile.connect.refreshSaved": "Оновити",
  "mobile.connect.qrComingSoon": "Сканування QR буде через камеру після підключення native pairing. Поки встав адресу сервера вручну.",
