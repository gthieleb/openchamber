...
export const dict: Record<I18nKey, string> = {
  ...
  'mobile.connect.token.placeholder': 'Optional',
  'mobile.connect.connectButton': 'Connect',
  'mobile.connect.connecting': 'Connecting...',
  'mobile.connect.scanQr': 'Scan QR',
  'mobile.connect.refreshSaved': 'Refresh',
  'mobile.connect.qrComingSoon': 'QR scanning will use the camera once native pairing is wired. For now, paste the server URL.',
